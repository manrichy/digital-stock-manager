...
echo "📝 Writing Aggregate Root (StockItem)..."
...
echo "✨ System generated perfectly with complete Domain Model source injection!"
echo "👉 Action: Refresh Maven inside IntelliJ now."